...
import com.meforwe.meforwe.Events;
...
public class EventsServiceImpl implements EventsService {
    ...
    @Override
    public Events getById(Integer eventsId) {
    ...
    @Transactional(readOnly = true, value = "meforweTransactionManager")
    @Override
    public List<Events> findByMultipleIds(List<Integer> eventsIds, boolean orderedReturn) {
    ...
    @Transactional(value = "meforweTransactionManager")
    @Override
    public Events delete(Integer eventsId) {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service meforwe for table Events to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service meforwe for table Events to {} format", options.getExportType());
