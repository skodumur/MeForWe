...
import com.meforwe.meforwe.service.EventsService;
...
public class EventsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Events editEvents(@PathVariable("id") Integer id, @RequestBody Events events) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteEvents(@PathVariable("id") Integer id) {
