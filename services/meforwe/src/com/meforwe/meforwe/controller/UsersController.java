...
import com.meforwe.meforwe.service.UsersService;
...
public class UsersController {
    ...
    public Users editUsers(@PathVariable("id") Integer id, @RequestBody Users users) {
        LOGGER.debug("Editing Users with id: {}" , users.getUserId());
